...
public class CategoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<OrderGoods> mCategoryBeen = new ArrayList<>();
...
//        notifyItemChanged(1,1);
    ...
    public CategoryAdapter(List<OrderGoods> categoryBeen) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_order_in, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            OrderGoods categoryBean = mCategoryBeen.get(pos);
...
//            });
    ...
    interface OnItemClickListener {
        void OnItemClick(View view, int position, OrderGoods categoryBean);
    }
}
