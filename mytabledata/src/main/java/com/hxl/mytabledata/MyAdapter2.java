...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.BaseViewHolder> {
    ...
    public class GoodsHolder extends BaseViewHolder<OrderBean>{
        ...
        public void bindData(OrderBean orderBean) {
            ...
            //TODO 处理数据
            orderNumber.setText(orderBean.getGoodName());
            oderType.setText(orderBean.getGoodSn());
            itemPrice.setText(orderBean.getItemPrice());
            platformDeduction.setText(orderBean.getPlatformDeduction());
            userPlay.setText(orderBean.getUserPlay());
            storeEntry.setText(orderBean.getStoreEntry());
            playTime.setText(orderBean.getPlayTime());
        }
    }
